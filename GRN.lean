...
the structural certificates, and the worked examples. The JSON bridge to quiver
lives in `GRN.Interop` (kept out of this import so the core stays free of the
